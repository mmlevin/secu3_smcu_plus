...
/** Return value of  hardware timer counter*/
uint8_t s_timer_get ();
...
extern volatile s_timer16_t bc_status_counter;
extern volatile s_timer8_t hall_timer;
extern void hall_timer_ovf_cb(void);
//////////////////////////////////////////////////////////////////
